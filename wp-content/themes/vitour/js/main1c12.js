...
(function ($) {
    ...
    var Modal_Right = function () {
        ...
        $(".modal-menu__body #mainnav-secondary .menu li").each(function (n) {
            if (
                ...
                ).append('<span class="icon-vitour-ona-38"></span>');
            }
    ...
    var headerFixed = function () {
        ...
        $(".page-template-page-dashboard #header").css("top", wpadminbar);
        
        $(".header-sticky").css("top", wpadminbar);
        $(".canvas-nav-wrap .inner-canvas-nav").css("top", wpadminbar);
        ...
        if ($("body:not(.page-template-page-dashboard)").hasClass("header_sticky")) {
            ...
            $(window).on("load scroll resize", function () {
                    ...
                    if ($(window).scrollTop() >= top_height + hd_height + 200) {
    ...
    var popup_search = function() {
        $('.popup-search-btn').on('click',function(e){
            e.preventDefault();
            $('.popup-search-wrap').addClass('active');
        })

        $('.popup-search-wrap .btn-close-search,.popup-search-wrap .overlay').on('click',function(e){
            e.preventDefault();
            $('.popup-search-wrap').removeClass('active');
        })
    }
