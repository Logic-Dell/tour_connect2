(function ($) {
    ...
    function babe_search_form_submit(setValue ){
        ...
        //     console.log('submit');
            $.ajax({
                type: 'POST',
                url: filter_var.ajax_url,               
                data:  args + '&action=handle_filter_tour&security=' + filter_var.filter_nonce + '&item_per_page_archive_listing=' + $item_per_page_archive_listing + '&setValue=' + setValue + '&css_class_col=' + $css_class_col + '&layout_archive_listing=' + $layout_archive_listing + '&show_cate=' + $show_cate + '&show_gallery=' + $show_gallery + '&show_video=' + $show_video + '&show_wishlist=' + $show_wishlist + '&show_review=' + $show_review + '&show_number_person=' + $show_number_person + '&show_day=' + $show_day + '&show_near_day=' + $show_near_day + '&show_price=' + $show_price + '&booking_pagination=' + $booking_pagination + '&thumbnai_image=' + $thumbnai_image,
                beforeSend: function () {
    ...
    var filter = function(){
      ...
      $( document.body ).unbind( 'babe_price_slider_change')
        ...
        $('#search_form .submit button,.search_apply_btn').on('click', function(ev){
            ev.preventDefault();
            //ev.stopPropagation();
            babe_search_form_submit();
            scrollToTopWithOffset('wrap-listing-post', 230);
